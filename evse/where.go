...
func EquipmentID(v datasource.UUID) predicate.Evse {
	vc := uint64(v)
	return predicate.Evse(func(s *sql.Selector) {
...
func EquipmentIDEQ(v datasource.UUID) predicate.Evse {
	vc := uint64(v)
	return predicate.Evse(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldEquipmentID), vc))
	})
...
func EquipmentIDNEQ(v datasource.UUID) predicate.Evse {
	vc := uint64(v)
	return predicate.Evse(func(s *sql.Selector) {
...
func EquipmentIDIn(vs ...datasource.UUID) predicate.Evse {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = uint64(vs[i])
	}
...
func EquipmentIDNotIn(vs ...datasource.UUID) predicate.Evse {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = uint64(vs[i])
	}
