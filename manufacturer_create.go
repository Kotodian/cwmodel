...
func (mc *ManufacturerCreate) AddFirmwareIDs(ids ...datasource.UUID) *ManufacturerCreate {
	mc.mutation.AddFirmwareIDs(ids...)
	return mc
}

// AddFirmware adds the "firmware" edges to the Firmware entity.
func (mc *ManufacturerCreate) AddFirmware(f ...*Firmware) *ManufacturerCreate {
...
func (mc *ManufacturerCreate) check() error {
	if _, ok := mc.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`cwmodel: missing required field "Manufacturer.version"`)}
	}
	if _, ok := mc.mutation.CreatedBy(); !ok {
		return &ValidationError{Name: "created_by", err: errors.New(`cwmodel: missing required field "Manufacturer.created_by"`)}
	}
	if _, ok := mc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`cwmodel: missing required field "Manufacturer.created_at"`)}
	}
	if _, ok := mc.mutation.UpdatedBy(); !ok {
		return &ValidationError{Name: "updated_by", err: errors.New(`cwmodel: missing required field "Manufacturer.updated_by"`)}
	}
	if _, ok := mc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`cwmodel: missing required field "Manufacturer.updated_at"`)}
	}
	if _, ok := mc.mutation.Code(); !ok {
		return &ValidationError{Name: "code", err: errors.New(`cwmodel: missing required field "Manufacturer.code"`)}
	}
	return nil
}
