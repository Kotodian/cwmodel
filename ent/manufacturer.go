...
func (e ManufacturerEdges) EquipmentOrErr() ([]*Equipment, error) {
	if e.loadedTypes[0] {
...
// QueryEquipment queries the "equipment" edge of the Manufacturer entity.
func (m *Manufacturer) QueryEquipment() *EquipmentQuery {
	return (&ManufacturerClient{config: m.config}).QueryEquipment(m)
}
