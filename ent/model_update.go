...
func (mu *ModelUpdate) AddEquipmentIDs(ids ...int) *ModelUpdate {
	mu.mutation.AddEquipmentIDs(ids...)
	return mu
}

// AddEquipment adds the "equipment" edges to the Equipment entity.
func (mu *ModelUpdate) AddEquipment(e ...*Equipment) *ModelUpdate {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
...
// AddEquipmentIDs adds the "equipment" edge to the Equipment entity by IDs.
func (muo *ModelUpdateOne) AddEquipmentIDs(ids ...int) *ModelUpdateOne {
	muo.mutation.AddEquipmentIDs(ids...)
	return muo
}

// AddEquipment adds the "equipment" edges to the Equipment entity.
func (muo *ModelUpdateOne) AddEquipment(e ...*Equipment) *ModelUpdateOne {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
...
// ClearEquipment clears all "equipment" edges to the Equipment entity.
func (muo *ModelUpdateOne) ClearEquipment() *ModelUpdateOne {
	muo.mutation.ClearEquipment()
	return muo
}

// RemoveEquipmentIDs removes the "equipment" edge to Equipment entities by IDs.
func (muo *ModelUpdateOne) RemoveEquipmentIDs(ids ...int) *ModelUpdateOne {
	muo.mutation.RemoveEquipmentIDs(ids...)
	return muo
}

// RemoveEquipment removes "equipment" edges to Equipment entities.
func (muo *ModelUpdateOne) RemoveEquipment(e ...*Equipment) *ModelUpdateOne {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
