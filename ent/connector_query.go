...
func (cgb *ConnectorGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ConnectorGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ConnectorGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{connector.Label}
	default:
		err = fmt.Errorf("ent: ConnectorGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ConnectorGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ConnectorGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ConnectorGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{connector.Label}
	default:
		err = fmt.Errorf("ent: ConnectorGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ConnectorGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ConnectorGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ConnectorGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{connector.Label}
	default:
		err = fmt.Errorf("ent: ConnectorGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ConnectorGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ConnectorGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ConnectorGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{connector.Label}
	default:
		err = fmt.Errorf("ent: ConnectorGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ConnectorSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ConnectorSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ConnectorSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{connector.Label}
	default:
		err = fmt.Errorf("ent: ConnectorSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ConnectorSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ConnectorSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ConnectorSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{connector.Label}
	default:
		err = fmt.Errorf("ent: ConnectorSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ConnectorSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ConnectorSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ConnectorSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{connector.Label}
	default:
		err = fmt.Errorf("ent: ConnectorSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ConnectorSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ConnectorSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ConnectorSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{connector.Label}
	default:
		err = fmt.Errorf("ent: ConnectorSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
