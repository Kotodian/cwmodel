...
var (
	...
	BaseConnectorColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeInt64, Default: 1666157482},
		{Name: "updated_by", Type: field.TypeUint64, Default: 1},
		{Name: "updated_at", Type: field.TypeInt64, Default: 1666157482},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{BaseConnectorColumns[14]},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{SmartChargingEffectColumns[13]},
				RefColumns: []*schema.Column{BaseConnectorColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
