...
type SmartChargingEvent struct {
	...
	// SmartID holds the value of the "smart_id" field.
	// 智慧id
...
func (*SmartChargingEvent) scanValues(columns []string) ([]interface{}, error) {
...
func (sce *SmartChargingEvent) assignValues(columns []string, values []interface{}) error {
