...
var (
	...
	BaseConnectorColumns = []*schema.Column{
		...
		{Name: "updated_by", Type: field.TypeUint64},
		{Name: "updated_at", Type: field.TypeInt64, Default: 1682039844},
		...
		{Name: "charging_state", Type: field.TypeInt},
	...
	BaseEquipmentColumns = []*schema.Column{
		...
		{Name: "protocol_version", Type: field.TypeString},
	}
	...
	EquipModelColumns = []*schema.Column{
		...
		{Name: "connector_category", Type: field.TypeInt},
	}
