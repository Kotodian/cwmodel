	...
	return func(s *sql.Selector) {
		...
		for _, f := range fields {
			if err := check(f); err != nil {
				s.AddError(&ValidationError{Name: f, err: fmt.Errorf("cwmodel: %w", err)})
			}
...
//	Aggregate(cwmodel.As(cwmodel.Sum(field1), "sum_field1"), (cwmodel.As(cwmodel.Sum(field2), "sum_field2")).
//	Scan(ctx, &v)
...
func Max(field string) AggregateFunc {
	return func(s *sql.Selector) string {
		...
		if err := check(field); err != nil {
			s.AddError(&ValidationError{Name: field, err: fmt.Errorf("cwmodel: %w", err)})
			return ""
		}
...
func (e *NotFoundError) Error() string {
	return "cwmodel: " + e.label + " not found"
}
...
func (e *NotSingularError) Error() string {
	return "cwmodel: " + e.label + " not singular"
}
...
func (e *NotLoadedError) Error() string {
	return "cwmodel: " + e.edge + " edge was not loaded"
}
...
func (e ConstraintError) Error() string {
	return "cwmodel: constraint failed: " + e.msg
}
...
func (s *selector) Strings(ctx context.Context) ([]string, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("cwmodel: Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) String(ctx context.Context) (_ string, err error) {
	...
	default:
		err = fmt.Errorf("cwmodel: Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Ints(ctx context.Context) ([]int, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("cwmodel: Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("cwmodel: Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Float64s(ctx context.Context) ([]float64, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("cwmodel: Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("cwmodel: Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Bools(ctx context.Context) ([]bool, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("cwmodel: Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("cwmodel: Bools returned %d results when one was expected", len(v))
	}
	return
}
