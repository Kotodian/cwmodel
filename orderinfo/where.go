...
func EquipmentID(v datasource.UUID) predicate.OrderInfo {
	vc := uint64(v)
	return predicate.OrderInfo(func(s *sql.Selector) {
...
func EquipmentIDEQ(v datasource.UUID) predicate.OrderInfo {
	vc := uint64(v)
	return predicate.OrderInfo(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldEquipmentID), vc))
	})
...
func EquipmentIDNEQ(v datasource.UUID) predicate.OrderInfo {
	vc := uint64(v)
	return predicate.OrderInfo(func(s *sql.Selector) {
...
func EquipmentIDIn(vs ...datasource.UUID) predicate.OrderInfo {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = uint64(vs[i])
	}
...
func EquipmentIDNotIn(vs ...datasource.UUID) predicate.OrderInfo {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = uint64(vs[i])
	}
