...
func (efec *EquipmentFirmwareEffectCreate) SetEquipmentID(d datasource.UUID) *EquipmentFirmwareEffectCreate {
	efec.mutation.SetEquipmentID(d)
	return efec
}
...
func (efec *EquipmentFirmwareEffectCreate) check() error {
	if _, ok := efec.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`cwmodel: missing required field "EquipmentFirmwareEffect.version"`)}
	}
	if _, ok := efec.mutation.CreatedBy(); !ok {
		return &ValidationError{Name: "created_by", err: errors.New(`cwmodel: missing required field "EquipmentFirmwareEffect.created_by"`)}
	}
	if _, ok := efec.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`cwmodel: missing required field "EquipmentFirmwareEffect.created_at"`)}
	}
	if _, ok := efec.mutation.UpdatedBy(); !ok {
		return &ValidationError{Name: "updated_by", err: errors.New(`cwmodel: missing required field "EquipmentFirmwareEffect.updated_by"`)}
	}
	if _, ok := efec.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`cwmodel: missing required field "EquipmentFirmwareEffect.updated_at"`)}
	}
	...
	if _, ok := efec.mutation.State(); !ok {
		return &ValidationError{Name: "state", err: errors.New(`cwmodel: missing required field "EquipmentFirmwareEffect.state"`)}
	}
	if _, ok := efec.mutation.EquipmentID(); !ok {
